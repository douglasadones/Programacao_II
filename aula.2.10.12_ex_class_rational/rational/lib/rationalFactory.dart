class Rational {
  ...
  const Rational(this.num, [this.den = 1]);
  ...
  Rational operator +(Rational r) =>
      Rational(num * r.den + r.num * den, den * r.den);

  Rational operator -(Rational r) =>
      Rational(num * r.den - r.num * den, den * r.den);

  Rational operator *(Rational r) => Rational(num * r.num, den * r.den);

  Rational operator /(Rational r) => Rational(num * r.den, den * r.num);
  ...
  // Para que o operador '==' compare os valores e não os endereços, pois o operador '==' já é sobrecarregado por padrão na classe Object
  @override
